...
<form action="filter.php" target="frame_main" align="right">
<button style="background-color:rgba(0, 0, 0, 0.8);color:orange;font-size:15px;width:20%;height:10%;border-radius:6px;"><img src="image/filter.png" style="height:30px;width:30px;" align="middle"><b>Apply Filters</b></button>
</form><br>
