...
if($gen =='female')
{
	...
	echo "<table style='font-family:Cambria;color:orange;font-size:20px;' ><tr><td style='color:white;font-family:Cambria;font-size:20px;'>NAME</td><td style='color:orange;font-family:Cambria;font-size:20px;'>".$row['name'].
		"</td></tr><tr><td style='color:white;font-family:Cambria;font-size:20px;'>AGE</td><td style='color:orange;font-family:Cambria;font-size:20px;'>".$row['username'].
		...
		"</td></tr><tr><td style='color:white;font-family:Cambria;font-size:20px;'>ABOUT MYSELF</td><td style='color:orange;font-family:Cambria;font-size:20px;'>".$row['about']."</td></tr></table>";
		mysqli_close($con);
